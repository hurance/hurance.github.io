...
// 第一块展板图片地址
billboardTextures.blogTexture = '../src/jsm/blucar.jpg';
// 第二块展板图片地址
...
boxTexture.allSkills = '../src/jsm/allskill.png';
...
// 文字图片地址
let inputText = {};
//inputText.terpSolutionsText = '../src/jsm/mine3.png';
...
URL.gitHub = 'https://github.com/hurance';
URL.BiliBili = 'https://space.bilibili.com/641721563';
URL.email = 'https://1253142184@qq.com';
//URL.music = 'https://music.huabyte.com';
URL.devTo =
  'http://wpa.qq.com/msgrd?v=3&uin=1253142184&site=qq&menu=yes"><img border="0" src="http://wpa.qq.com/pa?p=2:1253142184:41';
